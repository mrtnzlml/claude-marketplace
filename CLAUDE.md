...
- The `rossum-sa` plugin has 7 invocable skills (analyze, dead-code, document, implement, refine-deployment, upgrade, write-sow) and 9 autoloaded reference packs (*-reference skills)
